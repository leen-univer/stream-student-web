...
import { adminNotificationContent, deleteContent } from "locale";
    ...
    <AdminPanelLayout>
      <section className="w-full">
        <h1 className="title-styling text-center pb-6 lg:pb-12">
          {adminNotificationContent(selectedLanguage).all}{" "}
          <span className="text-primary">
            {adminNotificationContent(selectedLanguage).Notifications}
          </span>
        </h1>
